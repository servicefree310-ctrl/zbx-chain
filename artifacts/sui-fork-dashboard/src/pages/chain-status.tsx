  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        desc: "Parallelize signature verification — 5-10x TPS boost",
        status: "planned",
        version: "v0.1.1",
      },
      {
        name: "Batch Ed25519 verification",
        desc: "ed25519-dalek built-in batch API — 3-5x boost",
        status: "planned",
        version: "v0.1.1",
      },
      {
        name: "Block-STM parallel execution",
        desc: "Aptos-style optimistic parallel execution — 10-50x boost",
        status: "planned",
        version: "v0.3",
      },
    ],
