...
const CHANGES_LOG = [
  ...
  },
  {
    ...
    entries: [
      ...
      { type: "add", text: "Format: pay_id = 'rahul' → full_id = 'rahul@zbx' (auto suffix), display_name = 'Rahul Kumar' (mandatory)" },
      { type: "add", text: "register_pay_id(registry, pay_id, display_name): dono fields required — E_NAME_EMPTY ya E_DISPLAY_NAME_EMPTY se abort" },
      { type: "add", text: "E_DISPLAY_NAME_EMPTY: u64 = 6 — naya error code, display_name without it = transaction fail" },
      { type: "add", text: "Uniqueness: Table<String, address> + Table<address, String> — bidirectional map, duplicate = abort" },
